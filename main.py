...
app.config['SECURITY_PASSWORD_SALT'] = 'w91{23@49%8)*KL:JF(P!!W@ri#p$fk%szlxkjm;'
...
app.config['SECURITY_EMAIL_SENDER'] = 'cory.thompson527@ncaa-pickem.awsapps.com'
...
app.config['MAIL_USERNAME'] = 'AKIAJ5YDM5YUPH6WKR4Q'
app.config['MAIL_PASSWORD'] = 'AjDy0PniHEbIKSAmzr13YG0qYQ+lDl1sYJ1IG4dU1l86'

# enable the '/register' route
